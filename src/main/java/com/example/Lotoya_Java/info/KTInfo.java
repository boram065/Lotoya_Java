...
//                String playerWeight = "";
//
//                Elements element = doc.select(".player_info dt span");
//                if (element.isEmpty()) {
//                    System.out.println("element 비어있음");
//                }
//                playerNumber = element.select(".back_num").text().replace("No. ", "").trim();
////                System.out.println(playerNumber);
////                numList.add(Integer.parseInt(playerNumber));
//
//                playerName = element.select(".back_num #text").text();
...
//                if (box != null) {
//                    System.out.println("box 있음");
//                } else {
//                    System.out.println("box 없음");
//                }
